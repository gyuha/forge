...
> 15개의 `fg-` 프리픽스 Claude Code 스킬로 구성된 루프형 워크플로우 플러그인 — 루프를 이루는 4개와, 루프 밖 유틸리티 11개(`fg-map`·`fg-quick`·`fg-status`·`fg-next`·`fg-loop`·`fg-tdd`·`fg-eco`·`fg-merge`·`fg-cleanup`·`fg-statusline`·`fg-adversarial-review`).
