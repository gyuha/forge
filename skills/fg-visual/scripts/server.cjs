...
function brandMarkup() {
  // Static local branding — no remote assets, no version telemetry.
  return '<div class="brand"><a href="https://github.com/gyuha/forge"><span class="brand-copy">⚒ forge — Visual Companion</span></a></div>';
}
