...
**Host contract**: read [../../core/HOST.md](../../core/HOST.md), [../../core/EXECUTION.md](../../core/EXECUTION.md), and the matching `../../hosts/<host>/execution.md` before delegating. If the host is unknown or delegation is unavailable, execute serially while preserving every state transition and verification gate.
