...
- **Before starting: check for existing work.** Do this cheap state glance **first — before the retro-feedback and codebase-map reads above** — so grilling starts fast and no expensive setup is wasted if the user bails to finish prior work.
