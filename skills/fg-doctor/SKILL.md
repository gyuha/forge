...
10. **Skill-count consistency.** The number of `skills/*/SKILL.md` matches the count word(s) in the manifest descriptions (e.g. "Eighteen … Fourteen more sit outside the loop"). A drift — **warning**.
